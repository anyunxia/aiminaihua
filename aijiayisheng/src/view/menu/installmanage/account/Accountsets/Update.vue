        ...
        <div class="form-content">
            ...
            <el-form ref="ruleForm" label-width="120px" label-position="left" v-loading="loading" :model="form" :rules="rules" status-icon>
                <el-form-item label="账户账号:" prop="loginAccount">
                    <el-input v-model.trim="form.loginAccount" placeholder="admin"></el-input>
                </el-form-item>
                ...
                <!-- <el-form-item label="备注信息" prop="loginNote">
                    <el-input type="textarea" v-model.trim="form.loginNote"></el-input>
                </el-form-item> -->
                <el-form-item label="备注信息" prop="loginNote" class="textareaInput">
                    <el-input type="textarea" placeholder="请输入备注信息" style="height:110px;" v-model.trim="form.loginNote" maxlength="100" resize="none" show-word-limit></el-input>
                </el-form-item>
            </el-form>
        </div>
    ...
    methods: {
        ...
        getListData() {
            ...
            web(config).then((response) => {
                ...
                this.form.loginPassword = response.data.data.loginPassword;
                this.form.policy_againpassword = response.data.data.loginPassword;
                this.form.loginName = response.data.data.loginName;
                this.form.roleId = response.data.data.loginRoleId;
