    ...
    <div>
        ...
        <div class="form-content">
            ...
            <el-form ref="ruleForm" label-width="120px" label-position="left" :model="form" :rules="rules" status-icon>
                ...
                <el-form-item label="头图" prop="orgUrl">
        ...
        <el-dialog width="50%" top="5vh" :visible.sync="innerVisible" append-to-body>
            <Nestselect ref="nestDialog" :dialog="dialog" :departmentsHospitalId="departmentsHospitalId" :departmentsHospitalCode="departmentsHospitalCode" @closeDialog="closeDialog"></Nestselect>  
        </el-dialog>
    </div>
</template>
