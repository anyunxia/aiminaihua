                ...
                <el-collapse v-model="activeNames">
                    ...
                    <el-collapse-item name="1">
                        <template slot="title">
                            ...
                            <div v-if="hxzbBtn" class="category category4">
                    ...
                    <el-collapse-item name="2" class="collapse-item2">
                        <template slot="title">
                            ...
                            <div v-if="yhqsBtn" class="category category4">
                        ...
                        <div class="hxzbdata hxzbdata-p yhqsdata" v-for="(item,index) in yhqsList">
        ...
        handlehxzbBtn(val){
            if(val==1){//昨日
               ...
               // var timestamp = Date.parse(time);时间转时间戳
                ...
                console.log( this.hxzbStartdate  ) //标准时间
                console.log( this.hxzbEnddate  ) //标准时间
            }else if(val==3){//本月
                this.hxzbBtn = false
