<template>
    <div class="list">
        ...
        <el-row type="flex" class="row-bg" justify="space-between">
            ...
            <el-col :span="5">
            <el-input v-model.trim="searchName" size="mini" placeholder="搜索订单编号" clearable class="other-input">
            ...
            <el-table border highlight-current-row size="small" v-loading="loading" :data="tableData">
                ...
                <el-table-column align="center" label="支付时间" show-overflow-tooltip>
                 ...
                 <el-table-column align="center" label="订单金额" show-overflow-tooltip>
                    <template slot-scope="scope">{{scope.row.orderamount ? scope.row.orderamount : "--"}}</template>
                </el-table-column>
                <el-table-column align="center" label="实付金额" show-overflow-tooltip>
                    <template slot-scope="scope">{{scope.row.realamount ? scope.row.realamount : "--"}}</template>
                </el-table-column>
                ...
                <el-table-column align="center" label="开票状态" show-overflow-tooltip>
                    <template slot-scope="scope">{{scope.row.facilityKc ? scope.row.facilityKc : "--"}}</template>
                </el-table-column>
